...
| Anahtar değişimi | RSA legacy taşıma + TR-31 key block | İki aşamalı F63 sözleşmesi, MSK/TCN/HCN ve RSA+3DES testleri hazır; host orchestration, HSM/SDK injection ve KCV kontrolü bekliyor; RKL/TR-34 kapsam dışı |
